...
{
    "location": "references.html#EzXML.depth-Tuple{EzXML.StreamReader}",
    "page": "References",
    "title": "EzXML.depth",
    "category": "Method",
    "text": "depth(reader::StreamReader)\n\nReturn the depth of the current node of reader.\n\n\n\n"
},
...
{
    "location": "references.html#EzXML.name-Tuple{EzXML.StreamReader}",
    "page": "References",
    "title": "EzXML.name",
    "category": "Method",
    "text": "name(reader::StreamReader)\n\nReturn the name of the current node of reader.\n\n\n\n"
},

{
    "location": "references.html#EzXML.content-Tuple{EzXML.StreamReader}",
    "page": "References",
    "title": "EzXML.content",
    "category": "Method",
    "text": "content(reader::StreamReader)\n\nReturn the content of the current node of reader.\n\n\n\n"
},
